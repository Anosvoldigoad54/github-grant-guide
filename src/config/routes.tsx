...
// Employee Management
const AdvancedEmployeeDirectory = React.lazy(() => 
  import('../components/employees/AdvancedEmployeeDirectory')
)
...
export const routeConfig: RouteConfig[] = [
  ...
  // HR Management Routes - Fix navigation redirect
  {
    ...
    children: [
      {
        path: '/hr/employees',
        element: <SuspenseWrapper><AdvancedEmployeeDirectory /></SuspenseWrapper>,
