...
const navigationItems = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'employee-management', label: 'Employee Management', icon: <PersonAdd />, path: '/hr/employee-management' },
      { id: 'organization-chart', label: 'Organization Chart', icon: <AccountTree />, path: '/hr/organization-chart' },
      { id: 'recruitment', label: 'Recruitment', icon: <PersonAdd />, path: '/hr/recruitment', badge: 3 },
