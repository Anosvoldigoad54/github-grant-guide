                ...
                InputProps={{
                  ...
                  endAdornment: (
                    <>
                      ...
                      <IconButton onClick={() => addSkill(params.inputProps.value || '')}>
                        <Add />
                      </IconButton>
                    </>
                  )
              ...
              {showFilters && (
                ...
                >
                  <Grid container spacing={responsive.getSpacing(2, 2)} sx={{ pt: 2 }}>
                    <Grid item {...responsive.getGridColumns(12, 6, 4)}>
                      <FormControl fullWidth size={responsive.getInputSize()}>
              ...
              <TableBody>
                {filteredEmployees.map((employee) => (
                  ...
                  >
                        ...
                        <Box>
                          ...
                          {responsive.isMobile && (
                            <Typography variant="caption" color="text.secondary" display="block">
                              {departmentMap[employee.department_id] || 'No Department'}
                            </Typography>
                          )}
                        </Box>
                      </Stack>
                    ...
                    <TableCell>
                      <Chip
                        label={statusConfigMap[employee.employment_status]?.label || employee.employment_status}
                        color={statusConfigMap[employee.employment_status]?.color as any || 'default'}
                        size="small"
                      />
                    </TableCell>
              ...
              <Stack direction="row" spacing={2} sx={{ width: '100%' }}>
                ...
                {activeStep < 3 ? (
                  ...
                  <Button
                    ...
                    disabled={saving}
                    startIcon={saving ? <LinearProgress size={20} /> : <Save />}
                  >
