...
export class OfflineDataService {
  ...
  static getDashboardMetrics() {
    console.log('📴 Using offline dashboard metrics')
    return {
      totalEmployees: 12,
      activeEmployees: 11,
      presentToday: 8,
  ...
  static getEmployeeStats() {
    console.log('📴 Using offline employee stats')
    return {
      totalEmployees: 12,
      activeEmployees: 11,
      presentToday: 8,
  ...
  static getEmployeeDirectory() {
    console.log('📴 Using offline employee directory')
    return {
      data: [
        {
          employee_id: 'EMP001',
  ...
  static getDepartments() {
    console.log('📴 Using offline departments')
    return [
      {
        id: 'dept-1',
        name: 'Engineering',
  ...
  static getLeaveRequests() {
    console.log('📴 Using offline leave requests')
    return [
      {
        id: 'leave-1',
        employee_id: 'EMP001',
